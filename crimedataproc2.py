...
class CrimeData(spatiotemporal_data_):
    ...
    def __init__(self, path, bin_path, livepath=None, file_dir=None):
        ...
        if file_dir is None:
            ...
            self.__file_dir = os.path.abspath(file_dir)
        self._meta_dict = None
        self._loc_timeseries = None
    ...
    @property
    def loc_timeseries(self):
        return self._loc_timeseries
    ...
    # temporary functions
    @meta_dict.setter
    def meta_dict(self, new_dict):
        self._meta_dict = new_dict
    ...
    def meta_properties(self, date_col="Date", type_col="Primary Type", lat_col="Latitude",\
        ...
        pickle.dump(self._meta_dict, open(self.__file_dir + "/" + meta_dict_pickle_fname, "wb"))
    ...
    def parse_loc(self):
        ...
        pickle.dump(rv, open(self.__file_dir + "/indexmap.p", "wb"))
    ...
    def transform(self, grid_size=200, force=False, date_col="Date", type_col="Primary Type",\
        ...
        pickle.dump(combined, open(self.__file_dir + "/" + loc_ts_pickle_fname, "wb"))
        self._loc_timeseries = combined
